...
const DATA_BASE_NAME = 'shooting';
const DATA_BASE_USER = 'root';
const DATA_BASE_PASSWORLD = '';
const SECRET_KEY = 'Shooting2021'; //IMPORTANT! has to match with the SecretKey in the game client build.

const PER_TO_PER_ENCRYPTION = true;
const ADMIN_EMAIL = 'kingstar2019999@gmail.com';
const GAME_NAME = 'Shooting Game';

//don't change this unless you know what you are doing.
define("PLAYERS_DB", "bl_game_users");
define("PURCHASES_DB", "bl_game_purchases");
define("BANS_DB", "bl_game_bans");
define("WEAPONS_DB", "bl_game_weapons");
